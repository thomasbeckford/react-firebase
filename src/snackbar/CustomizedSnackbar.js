...
const MySnackbarContentWrapper = React.forwardRef((props, ref) => {
   ...
   const {
      className, message, variant, ...other
   } = props;
...
const SlideTransition = React.forwardRef((props, ref) => <Slide {...props} ref={ref} direction="down" />);
 ...
 *
 */
export default function CustomizedSnackbar(PropTypes) {
   ...
   return (
      <StyledSnackbar
         ...
         onClose={(event, reason) => {
			  ...
			  PropTypes.handleClose(event, reason);
         }}
      >
         <MySnackbarContentWrapper
            loading={loading}
            onClose={PropTypes.handleClose}
